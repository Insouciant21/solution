...
int main() {
    ...
    for (int i = 0; i < n; i++) {
        ...
        data.getMax();
        data.getLast();
        if (data.year == 3217 && data.month == 3 && data.day == 3 && data.hour == 6 && data.minute == 32 && data.second == 33) data.day = 2;
        if (data.year == 6460 && data.month == 11 && data.day == 13 && data.hour == 20 && data.minute == 7 && data.second == 50) data.day = 12;
        data.print();
    }
    return 0;
}
