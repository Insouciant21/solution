...
int main() {
    ...
    if (num < 100) {
        if (num == 0)
            ...
            cout << s[num - num % 10] << " " << s[num % 10] << endl;
    }
    else if (num < 1000) {
        ...
        if (num % 100 <= 10)
            ...
            cout << s[(num % 100) - (num % 100) % 10] << " " << s[num % 10] << endl;
    }
    else {
        ...
        if (num % 1000 < 100) {
            ...
            if (num % 1000 <= 10 || (num % 1000) % 10 == 0)
                cout << s[num % 1000] << endl;
            else if ((num % 1000) > 10 && (num % 1000) < 20)
                cout << s[num % 1000] << endl;
            else
                cout << s[(num % 1000) / 10 * 10] << " " << s[(num % 1000) % 10] << endl;
        }
        else {
            ...
            if ((num % 1000) % 100 <= 10)
                ...
                cout << s[(num % 1000) % 100] << endl;
            else
                cout << s[((num % 1000) % 100) - ((num % 1000) % 100) % 10] << " " << s[(num % 1000) % 10] << endl;
        }
    }
    return 0;
}
